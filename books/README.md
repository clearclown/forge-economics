...
しかし、**著作権上の理由により、PDF ファイルはこのリポジトリには同梱しません**。代わりに、以下の外部参照リンクを提示します。読者は各自のルートで入手してください。

## 三つの源流

### ミクロ経済学 (Microeconomics)

- **書名**: *Principles of Microeconomics* ／ *Microeconomics*
- **著者（例）**: N. Gregory Mankiw / Paul Krugman & Robin Wells / Hal R. Varian
- **年**: 各版（Mankiw 9th ed. 2020 / Krugman 6th ed. 2021 / Varian 9th ed. 2019 など）
- **参照リンク**:
...
- **書名**: *Principles of Macroeconomics* ／ *Macroeconomics*
- **著者（例）**: N. Gregory Mankiw / Paul Krugman & Robin Wells / Olivier Blanchard
- **年**: 各版（Mankiw 10th ed. 2021 / Krugman 6th ed. 2021 / Blanchard 8th ed. 2020 など）
- **参照リンク**:
...
- **書名**: 『賃金・価格および利潤』（原題: *Value, Price and Profit*）
...
1. **無料で始めたい読者へ**: OpenStax と Khan Academy はすべて無償・公開ライセンスで、ミクロ・マクロ経済学の基礎を網羅しています。まずここから始めてください。
2. **体系的に学びたい読者へ**: Mankiw / Krugman などの定番教科書を各国のオンライン書店（Amazon、紀伊國屋、honto 等）または大学図書館から入手してください。
3. **マルクス経済学を読みたい読者へ**: Marxists Internet Archive は全文パブリックドメインで公開されており、そのまま読めます。翻訳の質は版により異なるため、複数の版を比較することを推奨します。
